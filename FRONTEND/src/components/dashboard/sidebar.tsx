...
import { reset } from '../../redux/slices/cart/cartSlice';
import { userLogout } from '../../redux/slices/users/loginSlice';
...
const Sidebar = () => {
  ...
  const userInfo: any = useAppSelector((state) => state.login);
  ...
  return (
    ...
    >
      <Container fluid>
        <Button
          className="navbar-toggler ms-n22"
