...
export const register = asyncHandler(async (req: Request, res: Response) => {
  ...
  console.log("Entre a userController - line 14 - register user");
  ...
  console.log("Entre a userController - line 29 - register user, exist: "+exist);
...
// export default (register:asyncHandler) => (async (req: Request, res: Response) => {
